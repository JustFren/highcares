[A, R] = readgeoraster("pht_DEM.tiff", OutputType="double");
...
geoshow(Agray, R, "DisplayType", "texturemap");
colormap(gray);
colorbar;
...
for i=1:1:46
  ...
  height(i,5) = abs(height(id1(i),4)-height(i,1))+ abs(height(i,1)-height(i,2))+abs(height(i,2)-height(i,3))+abs(height(i,3)-height(id2(i),4));
   ...
   plotm([lat0(id1(i)),lat1(i)], [lon0(id1(i)),lon1(i)], '-r', 'MarkerFaceColor','r', 'MarkerSize',6);
   plotm([lat1(i),lat2(i)], [lon1(i),lon2(i)], '-r', 'MarkerFaceColor','r', 'MarkerSize',6);
   plotm([lat2(i),lat3(i)], [lon2(i),lon3(i)], '-r', 'MarkerFaceColor','r', 'MarkerSize',6);
   plotm([lat3(i),lat0(id2(i))], [lon3(i),lon0(id2(i))], '-r', 'MarkerFaceColor','r', 'MarkerSize',6); 
